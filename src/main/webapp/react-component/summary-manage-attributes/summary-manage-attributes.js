    ...
    return (React.createElement(Button, { "data-id": "manage-attributes-button", onClick: function () {
            dialogContext.setProps({
                ...
                children: (React.createElement("div", { style: {
                    ...
                    React.createElement(TransferList, { startingLeft: TypedUserInstance.getResultsAttributesSummaryShown(), startingRight: TypedUserInstance.getResultsAttributesPossibleSummaryShown(), startingHideEmpty: user
                            .get('user')
                            .get('preferences')
