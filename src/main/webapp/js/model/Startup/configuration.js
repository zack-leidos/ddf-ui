...
var Configuration = /** @class */ (function (_super) {
    ...
    function Configuration(startupData) {
        ...
        _this.isHiddenAttribute = function (attribute) {
            ...
            return match(_this.getHiddenAttributes(), attribute);
        };
        _this.getHiddenAttributes = function () {
            var _a;
            return ((_a = _this.config) === null || _a === void 0 ? void 0 : _a.hiddenAttributes) || [];
        };
        ...
        _this.getWebSocketsEnabled = function () {
            var _a;
            return ((_a = _this.config) === null || _a === void 0 ? void 0 : _a.webSocketsEnabled) || true;
        };
