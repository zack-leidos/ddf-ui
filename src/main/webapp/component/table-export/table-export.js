...
import { getExportOptions, Transformer, getColumnOrder, } from '../../react-component/utils/export';
...
export var getDownloadBody = function (downloadInfo) {
    var _a;
    var exportSize = downloadInfo.exportSize, customExportCount = downloadInfo.customExportCount, selectionInterface = downloadInfo.selectionInterface;
    var exportResultLimit = StartupDataStore.Configuration.getExportLimit();
    ...
    var exportCount = Math.min(getExportCount({ exportSize: exportSize, selectionInterface: selectionInterface, customExportCount: customExportCount }), exportResultLimit);
    var args = {
...
var TableExports = function (_a) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        setFormats(exportFormats.map(function (exportFormat) { return ({
    ...
    return (React.createElement(TableExport, { exportFormats: formats, selectionInterface: selectionInterface, getWarning: getWarning, onDownloadClick: generateOnDownloadClick(addSnack) }));
};
