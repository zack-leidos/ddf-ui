...
export var Editor = function (_a) {
    ...
    var _g = useMetacardDefinitions(), getAlias = _g.getAlias, isMulti = _g.isMulti, getType = _g.getType, getEnum = _g.getEnum;
...
var getHiddenAttributes = function (selection, activeAttributes) {
    return Object.values(StartupDataStore.MetacardDefinitions.getMetacardDefinition(selection.plain.metacardType))
        ...
        .filter(function (val) {
        return !StartupDataStore.MetacardDefinitions.isHiddenTypeExceptThumbnail(val.id);
    });
};
...
var Summary = function (_a) {
    ...
    var _h = __read(React.useState(getSummaryShown()), 2), summaryShown = _h[0], setSummaryShown = _h[1];
    useRerenderOnBackboneSync({ lazyResult: selection });
    var dialogContext = useDialog();
    var listenTo = useBackbone().listenTo;
    var isHiddenAttribute = useConfiguration().isHiddenAttribute;
    var _j = useMetacardDefinitions(), isHiddenTypeExceptThumbnail = _j.isHiddenTypeExceptThumbnail, getMetacardDefinition = _j.getMetacardDefinition;
