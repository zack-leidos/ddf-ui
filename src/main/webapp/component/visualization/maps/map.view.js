...
var handleMapHover = function (_a) {
    var mapModel = _a.mapModel, selectionInterface = _a.selectionInterface, mapEvent = _a.mapEvent, setIsHoveringResult = _a.setIsHoveringResult, setEditableGeo = _a.setEditableGeo;
    ...
    if (isHoveringOverGeo)
        setEditableGeo(Boolean(mapEvent.mapLocationId));
    else
        setEditableGeo(undefined);
};
var useMapListeners = function (_a) {
    ...
    var _c = __read(React.useState(undefined), 2), editableGeo = _c[0], setEditableGeo = _c[1];
    React.useEffect(function () {
...
var useChangeCursorOnHover = function (_a) {
    var mapElement = _a.mapElement, isHoveringResult = _a.isHoveringResult, editableGeo = _a.editableGeo, isDrawing = _a.isDrawing;
    React.useEffect(function () {
        if (mapElement) {
            ...
            if (canvas && !isDrawing) {
                ...
                if (editableGeo === false)
                    canvas.style.cursor = 'not-allowed';
                if (editableGeo === undefined)
                    canvas.style.cursor = '';
                if (isHoveringResult)
...
export var MapViewReact = function (props) {
    ...
    var _e = useMapListeners({
        ...
        mapModel: mapModel,
        selectionInterface: props.selectionInterface,
    }), isHoveringResult = _e.isHoveringResult, editableGeo = _e.editableGeo;
