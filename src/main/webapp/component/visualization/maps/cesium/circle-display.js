...
var drawGeometry = function (_a) {
    ...
    var model = _a.model, map = _a.map, id = _a.id, onDraw = _a.onDraw;
...
var useListenToModel = function (_a) {
    var model = _a.model, map = _a.map, newCircle = _a.newCircle, onDraw = _a.onDraw;
...
export var CesiumCircleDisplay = function (_a) {
    ...
    useListenToModel({ map: map, model: model, newCircle: newCircle, onDraw: onDraw });
    React.useEffect(function () {
        return function () {
            if (model && map) {
