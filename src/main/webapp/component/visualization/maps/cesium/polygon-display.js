        ...
        polygons.forEach(function (polygonPoints) {
            ...
            if (buffer > 0) {
                ...
                bufferedPolygon === null || bufferedPolygon === void 0 ? void 0 : bufferedPolygon.geometry.coordinates.forEach(function (coords) {
                    return pc_1.add(constructOutlinedLinePrimitive({ coordinates: coords, model: model, id: id }));
                });
                pc_1.add(constructDottedLinePrimitive({ coordinates: polygonPoints, model: model }));
            }
            else {
...
var useListenToLineModel = function (_a) {
    var model = _a.model, map = _a.map, onDraw = _a.onDraw, newPoly = _a.newPoly;
...
export var CesiumPolygonDisplay = function (_a) {
    ...
    useListenToLineModel({ map: map, model: model, newPoly: newPoly, onDraw: onDraw });
    React.useEffect(function () {
        return function () {
            if (model && map) {
