...
export var drawPolygon = function (_a) {
    var map = _a.map, model = _a.model, polygon = _a.polygon, id = _a.id;
    if (!polygon) {
...
var updatePrimitive = function (_a) {
    ...
    if (polygon !== undefined) {
        drawPolygon({ map: map, model: model, polygon: polygon, id: id });
    }
};
...
export var OpenlayersPolygonDisplay = function (_a) {
    ...
    useListenToPolygonModel({ map: map, model: model });
